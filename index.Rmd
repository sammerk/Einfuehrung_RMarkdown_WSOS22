...
knitr::include_graphics("img/just_a_scratch.jpg")
```
...
`r typedjs::typed(c("Hallo und 💚-lich Willkommen!", "Der Workshop soll eine Hands-On Einführung in RMarkdown sein.", "Wichtig wäre dazu, dass ihr R und RStudio installiert habt sowie die R-Pakete {rmarkdown} und {tinytex}"), typeSpeed = 80, backSpeed = 20, backDelay = 3000, loop = T, contentType = "html")` 
